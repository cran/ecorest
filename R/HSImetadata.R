...
#'
#' @format A data frame with 351 rows and 85 variables:
#'
#' \describe{
...
#'   \item{website}{Link to individual model source}
#'   \item{SIV1}{Suitability index values for each organism specific condition}
#'   \item{SIV1B}{Suitability index values for each organism specific condition}
#'   \item{SIV2}{Suitability index values for each organism specific condition}
#'   \item{SIV2B}{Suitability index values for each organism specific condition}
#'   \item{SIV3}{Suitability index values for each organism specific condition}
#'   \item{SIV3B}{Suitability index values for each organism specific condition}
#'   \item{SIV4}{Suitability index values for each organism specific condition}
#'   \item{SIV4B}{Suitability index values for each organism specific condition}
#'   \item{SIV5}{Suitability index values for each organism specific condition}
#'   \item{SIV5B}{Suitability index values for each organism specific condition}
#'   \item{SIV6}{Suitability index values for each organism specific condition}
#'   \item{SIV6B}{Suitability index values for each organism specific condition}
#'   \item{SIV7}{Suitability index values for each organism specific condition}
#'   \item{SIV7B}{Suitability index values for each organism specific condition}
#'   \item{SIV8}{Suitability index values for each organism specific condition}
#'   \item{SIV8B}{Suitability index values for each organism specific condition}
...
#'   \item{SIV15B}{Suitability index values for each organism specific condition}
#'   \item{SIV16}{Suitability index values for each organism specific condition}
#'   \item{SIV16B}{Suitability index values for each organism specific condition}
...
#'   \item{CRF}{Food/reproduction component equation}
#'   \item{CRN}{Roosting-nesting component equation}
#'   \item{CC}{Cover component equation}
#'   \item{CCRO}{Cover roosting component equation}
#'   \item{CCRF}{Cover-reproduction-food component equation}
#'   \item{CCF}{Cover-food component equation}
#'   \item{CCSF}{Cover-food shrub component equation}
#'   \item{CCHF}{Cover-food herbaceous component equation}
#'   \item{CWF}{Winter food component}
#'   \item{CSF}{Summer food component}
#'   \item{CFF}{Fall food component}
#'   \item{CW}{Water component}
#'   \item{CCB}{Cover breeding component}
#'   \item{CB}{Brood component}
#'   \item{CN}{Nest component}
#'   \item{CNBC}{Nest-brood cover component}
#'   \item{CCN}{Cover nesting component}
#'   \item{CP}{Pair habitat component}
...
#'   \item{CIN}{Interspersion component}
#'   \item{CNI}{Non-island component}
#'   \item{CWFC}{Winter cover food component}
#'   \item{CFBS}{Summer food brood component}
#'   \item{CFSWF}{Fall spring winter food component}
#'   \item{CSPF}{Spring food component}
#'   \item{CWC}{Winter cover component}
#'   \item{CCFS}{Fall to spring cover component}
#'   \item{CSS}{Substrate-suspended solids component}
#'   \item{CT}{Topography component}
#'   \item{CTe}{Temperature component}
